...
namespace TimedRemindTool
{
    public class AutoRun
    {
        ...
        /// 快捷方式名称-任意自定义
        /// </summary>
        public static string QuickName { get { return Process.GetCurrentProcess().MainModule.ModuleName.Replace(".exe",""); } }
        ...
        {
            return Convert.ToBoolean(GetQuickFromFolder(SystemStartPath, AppAllPath).Count > 0);
        }
